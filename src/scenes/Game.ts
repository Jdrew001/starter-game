...
export default class Game extends Phaser.Scene {
    ...
    create() {
        ...
        this.bookcase1 = this.add.image(Phaser.Math.Between(2200, 2700), 580, TextureKeys.Bookcase1)
            .setOrigin(0.5, 1);
        this.bookcase2 = this.add.image(Phaser.Math.Between(2200, 2700), 580, TextureKeys.Bookcase2)
            .setOrigin(0.5, 1);
    ...
    private wrapBookcases() {
        ...
        if (this.bookcase1.x + width < scrollX) {
            ...
            const overlap = this.windows.find(bc => Math.abs(this.bookcase1.x - bc.x) <= this.bookcase1.width);
        ...
        if (this.bookcase2.x + width < scrollX) {
            ...
            const overlap = this.windows.find(bc => Math.abs(this.bookcase2.x - bc.x) <= this.bookcase2.width);
